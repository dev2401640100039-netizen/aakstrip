...
export default function Hero() {
  const words = [
    ...
    "LLMs, RAG & Generative AI Developer",
    "MLOps, FastAPI & Scalable AI Deployment"
  ];

  const [code] = useState(`
const profile = {
    name: 'Aakansha Tripathi',
    title: "AI + Full Stack Engineer | Generative AI | Scalable Systems",
    skills: [
        "Python", "TypeScript", "SQL",
        "NumPy", "Pandas", "Scikit-learn",
        "PyTorch", "Transformers", "Hugging Face",
        "LangChain", "RAG", "Vector Databases (FAISS, ChromaDB)",
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  AI/ML Engineer 🚀 | Designing Scalable AI Systems 🤖 | From Data Pipelines to Production 💻
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                {/* <a
                  href="https://github.com/Aakansha-Tripathii"
